        ...
        <div class="container-fluid">
          ...
          <div class="row page-titles">
            <div class="col-md-5 col-8 align-self-center">
              <h3 class="text-themecolor m-b-0 m-t-0">Calcule de la durée</h3>
              <ol class="breadcrumb">
                <li class="breadcrumb-item">
                  <a href="javascript:void(0)">Home</a>
                </li>
                <li class="breadcrumb-item active">Calcule de la durée</li>
              </ol>
            </div>
          </div>
          <!-- ============================================================== -->
            ...
            <div class="col-md-6">
              <div class="card card-outline-danger text-center">
                <div class="card-header">
                  <h4 class="m-b-0 text-white">Durée</h4>
                </div>
                <div class="card-body">
                  <h3 class="card-title">
                    Résultat : <% if (session.getAttribute("dureerep") != null)
                    { %> ${dureerep} <% } else { %> pas de résultat <% } %>
                  </h3>
                  <br />

                  <h3 class="card-title">
                    Etat d'enregistrement : <% if
                    (session.getAttribute("dureerep") != null) { %> <% if
              ...
              <div class="card card-outline-info">
                <div class="card-header">
                  <h4 class="m-b-0 text-white">
                    formulaire de calcule de la durée
                  </h4>
                </div>
                <div class="card-body">
                  <form
                    ...
                    id="formDuree"
                    method="POST"
                    action="${pageContext.request.contextPath}/duree"
                  >
                    <div class="form-group">
