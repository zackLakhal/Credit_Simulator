        ...
        <div class="container-fluid">
          ...
          <div class="row page-titles">
            <div class="col-md-5 col-8 align-self-center">
              <h3 class="text-themecolor m-b-0 m-t-0">Calcule d'annuitée</h3>
              <ol class="breadcrumb">
                <li class="breadcrumb-item">
                  <a href="javascript:void(0)">Home</a>
                </li>
                <li class="breadcrumb-item active">Calcule d'annuitée</li>
              </ol>
            </div>
          </div>
          <!-- ============================================================== -->
            ...
            <div class="col-md-6">
              <div class="card card-outline-danger text-center">
                <div class="card-header">
                  <h4 class="m-b-0 text-white">Annuitée</h4>
                </div>
                <div class="card-body">
                  <h3 class="card-title">
                    Résultat : <% if (session.getAttribute("anuiterep") != null)
                    { %> ${anuiterep} <% } else { %> pas de résultat <% } %>
                  </h3>
                  <br />

                  <h3 class="card-title">
                    Etat d'enregistrement : <% if
                    (session.getAttribute("anuiterep") != null) { %> <% if
              ...
              <div class="card card-outline-info">
                <div class="card-header">
                  <h4 class="m-b-0 text-white">
                    formulaire de calcule d'annuitée
                  </h4>
                </div>
                <div class="card-body">
                  <form
                    ...
                    id="formAnnuite"
                    method="POST"
                    action="${pageContext.request.contextPath}/annuite"
                  >
                    <div class="form-group">
                      <label for="Capital">Entrez votre Capital :</label>
                      <div class="input-group">
                        <div class="input-group-addon">
                          <i class="fa fa-money"></i>
                        </div>
